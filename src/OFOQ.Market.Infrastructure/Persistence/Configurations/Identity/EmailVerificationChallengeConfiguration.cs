...
internal sealed class EmailVerificationChallengeConfiguration :
    IEntityTypeConfiguration<EmailVerificationChallenge>
{
    public void Configure(
        EntityTypeBuilder<EmailVerificationChallenge> builder)
    {
        builder.ToTable(
        ...
        builder.Property(
            ...
            .HasConversion(
                id =>
                    id.Value,
                value =>
                    EmailVerificationChallengeId.From(
                        value))
            .HasColumnName(
                "id")
            .ValueGeneratedNever();
        ...
        builder.HasIndex(
            ...
            .HasDatabaseName(
                "ix_email_verification_challenges_user_expires");
