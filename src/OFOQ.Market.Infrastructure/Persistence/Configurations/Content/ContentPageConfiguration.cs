...
public sealed class ContentPageConfiguration : IEntityTypeConfiguration<ContentPage>
{
    public void Configure(EntityTypeBuilder<ContentPage> b)
    {
        ...
        b.Property(x => x.Kind).HasColumnName("page_kind").HasConversion<int>().HasDefaultValue(ContentPageKind.Standard).IsRequired();
        b.Property(x => x.HeroImageUrl).HasColumnName("hero_image_url").HasMaxLength(ContentPage.MaxHeroImageUrlLength);
        b.Property(x => x.ShowCustomerCount).HasColumnName("show_customer_count").HasDefaultValue(true).IsRequired();
        b.Property(x => x.ShowCompletedOrderCount).HasColumnName("show_completed_order_count").HasDefaultValue(true).IsRequired();
        b.Property(x => x.ShowUnitsSold).HasColumnName("show_units_sold").HasDefaultValue(true).IsRequired();
        b.Property(x => x.ShowAverageRating).HasColumnName("show_average_rating").HasDefaultValue(true).IsRequired();
        b.Property(x => x.ShowReviewCount).HasColumnName("show_review_count").HasDefaultValue(true).IsRequired();
        b.Property(x => x.ShowCountryCount).HasColumnName("show_country_count").HasDefaultValue(true).IsRequired();
