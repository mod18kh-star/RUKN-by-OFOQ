...
public static class TenantStoreProfileEndpoints
{
        ...
        try
        {
            await handler.HandleAsync(
                new UpdateStoreProfileCommand(
                    ...
                    request.ShowCustomerServicePhone,
                    request.ShowSecondaryPhone,
                    request.ShowLandlinePhone,
                    request.ShowPhysicalAddress,
                    request.ShowCommercialRegistration,
                    actorUserId.Value),
                cancellationToken);
        ...
        StoreProfileResult result)
    {
        return new StoreProfileResponse(
            ...
            result.ShowWebsite,
            result.ShowWhatsApp,
            result.ShowCustomerServicePhone,
            result.ShowSecondaryPhone,
            result.ShowLandlinePhone,
            result.ShowPhysicalAddress,
            result.ShowCommercialRegistration,
            result.SocialLinks
                .Select(
                    item =>
