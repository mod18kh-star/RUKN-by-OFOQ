...
public sealed class TenantPaymentAdministrationAuthorizationHandler :
    AuthorizationHandler<TenantPaymentAdministrationRequirement>
{
    ...
    public TenantPaymentAdministrationAuthorizationHandler(
    ...
    protected override async Task HandleRequirementAsync(
        ...
        TenantPaymentAdministrationRequirement requirement)
    {
